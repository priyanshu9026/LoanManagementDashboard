...
const UserComponent = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      {/* Navbar */}
      <nav className="flex flex-wrap justify-between items-center bg-white shadow px-6 py-4">
        <h1 className="text-xl font-bold text-green-800">CREDIT APP</h1>
        <div className="flex flex-wrap gap-4 items-center text-green-800">
          <FaHome className="text-lg" /> <span className="hidden sm:inline">Home</span>
          <FaWallet className="text-lg" /> <span className="hidden sm:inline">Payments</span>
          <FaCreditCard className="text-lg" /> <span className="hidden sm:inline">Budget</span>
          <FaWallet className="text-lg" /> <span className="hidden sm:inline">Card</span>
      ...
      <div className="flex flex-wrap justify-between items-center px-6 py-4 gap-4">
        <div className="bg-white shadow-md rounded p-4 flex items-center gap-4 w-full sm:w-auto">
        ...
        <button
          ...
          className="bg-gray-300 px-4 py-2 rounded shadow w-full sm:w-auto"
        >
          Get A Loan
        </button>
      </div>
      ...
      {/* Action Buttons */}
      <div className="flex flex-wrap justify-center gap-2 py-2 px-6">
        <button className="bg-white border px-6 py-2 rounded shadow w-full sm:w-auto">
          Borrow Cash
        </button>
        <button className="bg-white border px-6 py-2 rounded shadow w-full sm:w-auto">
          Transact
